...
class Api {
  ...
  constructor(model = this.model) {
    ...
    //GET ONE
    router.get("/" + model.tableName + "/:id", (req, res) =>
      this.getOne(req, res)
    );
    //insert ONE
    ...
    //update
    router.put("/" + model.tableName + "/:id", (req, res) =>
      this.updateOne(req, res)
    );

    //delete
    router.delete("/" + model.tableName + "/:id", (req, res) =>
      this.deleteOne(req, res)
    );

    //search
    router.post("/" + model.tableName + "/search", (req, res) =>
      this.search(req, res)
    );

    //getOneWith
    router.post("/" + model.tableName + "_with", (req, res) =>
      this.getOnewith(req, res)
    );

    //count
    router.get("/count/" + model.tableName, (req, res) =>
      this.getCount(req, res)
    );
  }
}
